...
3. Description of print statements 
    ...
    printf("%d, u16Dist: %d, dAngle: %f, is_invalid: %d\n", i, dataPack[i].u16Dist, dataPack[i].dAngle, dataPack[i].flag);
    
    From left to right:
    i           -> index number of data package (0-7)
    u16Dist        -> distance info (unit: mm)
    dAngle       -> dAngle info (in degrees)
    ...
    FD        -> first dAngle info of single-turn data packages
    LD        -> last dAngle info of single-turn data packages
